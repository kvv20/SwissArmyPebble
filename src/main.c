...
static char *menu_item_titles[NUM_MENU_SECTIONS][MAX_MENU_ITEMS] = {{"Wi-Fi","Data","Inet"},{"Vibrate", "Ring", "Siren"}};
static int menu_item_to_send[NUM_MENU_SECTIONS][MAX_MENU_ITEMS] = {{KEY_TOGGLE,KEY_TOGGLE,KEY_TOGGLE},{KEY_CONTROL, KEY_CONTROL, KEY_CONTROL}};
static uint16_t menu_item_count[] = {3,3};
